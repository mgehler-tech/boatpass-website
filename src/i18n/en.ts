...
export const en: Translations = {
  ...
  pricing: {
    ...
    seePaidFeatures: ['Unlimited study questions', 'Exam simulation', 'Question browser'],
    catalog3Name: 'UBI radio certificate',
    catalog3Desc: 'UKW radio certificate (inland) · official question catalog',
    ubiPaidFeatures: ['Unlimited study questions', 'Exam simulation', 'Question browser'],
    ubiPrice: '€5.99',
    lrcName: 'LRC sea radio',
    lrcDesc: 'Long Range Certificate (sea radio) · official question catalog',
    lrcPaidFeatures: ['Unlimited study questions', 'Exam simulation', 'Question browser'],
    lrcPrice: '€6.99',
    srcName: 'SRC sea radio',
    srcDesc: 'Short Range Certificate (coastal sea radio) · official question catalog',
    srcPaidFeatures: ['Unlimited study questions', 'Exam simulation', 'Question browser'],
    srcPrice: '€6.99',
