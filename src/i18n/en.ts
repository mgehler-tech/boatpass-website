...
export const en: Translations = {
  ...
  pricing: {
    ...
    // Mechanics apply to every purchase – stated once centrally instead of repeated on every card
    includedLabel: 'Included in every purchase',
    includedFeatures: ['Unlimited study questions', 'Exam simulation', 'Error training', 'No subscription'],
    questionsUnit: 'questions',
    themesUnit: 'topics',
    catalog1Name: 'SBF Binnen',
    catalog1Tagline: '15 questions daily for free – shared across all licenses',
    freeLabel: 'Free',
