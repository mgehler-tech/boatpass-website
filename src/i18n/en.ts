...
export const en: Translations = {
  ...
  pricing: {
    ...
    guaranteeText: 'We keep every catalogue current – at no extra cost. You always learn with the latest official questions.',
    sbfHeading: 'SBF – Boating licences',
    cardFeatures: ['Official question catalogue', 'Lifetime updates', 'Always up to date', 'Learn offline'],
    bundleFeatures: ['Everything from Inland', 'Everything from Coastal', 'Always up to date', 'Lifetime updates', 'Learn offline'],
    popular: 'Most popular',
    bundleInclusive: 'Both catalogues included',
    funkHeading: 'Radio certificates',
    funkSubtitle: 'Add the official radio certificates to your licence.',
    funkMore: 'Learn more',
