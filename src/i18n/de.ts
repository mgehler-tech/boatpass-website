export const de = {
  ...
  pricing: {
    ...
    seePaidFeatures: ['Unbegrenzte Lernfragen', 'Prüfungssimulation', 'Fragen-Browser'],
    catalog3Name: 'UBI Sprechfunk',
    catalog3Desc: 'UKW-Sprechfunkzeugnis Binnen · offizieller Fragenkatalog',
    ubiPaidFeatures: ['Unbegrenzte Lernfragen', 'Prüfungssimulation', 'Fragen-Browser'],
    ubiPrice: '€ 5,99',
    lrcName: 'LRC Seefunk',
    lrcDesc: 'Langstreckenfunkzeugnis (Seefunk) · offizieller Fragenkatalog',
    lrcPaidFeatures: ['Unbegrenzte Lernfragen', 'Prüfungssimulation', 'Fragen-Browser'],
    lrcPrice: '€ 6,99',
    srcName: 'SRC Seefunk',
    srcDesc: 'Kurzstreckenzeugnis (Seefunk Küste) · offizieller Fragenkatalog',
    srcPaidFeatures: ['Unbegrenzte Lernfragen', 'Prüfungssimulation', 'Fragen-Browser'],
    srcPrice: '€ 6,99',
