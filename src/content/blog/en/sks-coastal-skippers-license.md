...
**[Knot skills](/en/blog/most-important-knots-sbf/)** are also part of the practical exam. You're tested on six knots out of a set of up to seven: figure-eight knot, reef knot, sheet bend, bowline, stopper knot, clove hitch, round turn with two half hitches, and securing a line to a cleat with a locking hitch. If you don't practice these regularly, it's easy to lose valuable time in the exam, since they need to be tied correctly under mild time pressure.
...
Before you even think about the SKS, your [SBF See](/en/sbf-coastal/) needs to be rock solid, since it's the entry requirement. The **Boatpass app** helps you get there with the complete official question catalog and realistic exam simulation, so that foundation is right from the start. If you're also weighing whether a motorboat or a sailboat suits you better, our article [Motorboat or Sailboat – Which SBF Do You Need?](/en/blog/motorboat-or-sailboat-which-sbf/) covers the background. And since many coastal yachts carry a VHF radio on board, it's worth checking our article on [UBI vs. SRC](/en/blog/ubi-vs-src-radio-license/) as well, since operating a radio on the coast requires its own separate certificate, the [**SRC**](/en/src/).
