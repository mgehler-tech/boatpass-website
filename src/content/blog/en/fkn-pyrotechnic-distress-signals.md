...
Pyrotechnic distress signals may **only be used to indicate a genuine emergency** and request help. That applies regardless of whether it's a P1 or P2 device. Firing one for practice, fun, or as a substitute for fireworks misuses a distress signal that, in the worst case, alerts and ties up real rescue services. Doing so is prohibited and can lead to serious consequences, from fines to being billed for an unnecessary rescue operation. For an overview of the other pyrotechnic and non-pyrotechnic distress signals and how they differ, see our article on [distress signals at sea](/en/blog/distress-signals-at-sea/).
