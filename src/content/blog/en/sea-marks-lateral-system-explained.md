...
**Memory aid:** "Coming in, **r**ed is on the **left** (port)." Green is then on the right (starboard) side.
...
- **Topmark:** cones **point to point** (looks like a wine glass – "**W**est = **W**ine glass")
