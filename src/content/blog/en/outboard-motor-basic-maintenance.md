...
- **Consider a fuel stabilizer for longer idle periods.** As described in our article on [winterizing your boat](/en/blog/winterizing-a-boat-checklist-for-winter-storage/), a fuel stabilizer can be worthwhile during extended layups. Whether and how much makes sense for your engine is something to check with the manufacturer or a qualified workshop.
...
- **Check the battery and cable connections.** Loose, corroded, or oxidized connections cause starting problems or electronics failures. A quick visual check, and cleaning the terminals if needed, is part of basic care, similar to the battery care that also plays a central role when [winterizing your boat](/en/blog/winterizing-a-boat-checklist-for-winter-storage/).
