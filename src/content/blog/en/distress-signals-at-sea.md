...
The acoustic counterparts in normal operation – who gives which sound and when – are summarized in our article on [sound signals for the boating license](/en/blog/sound-signals-sbf-explained/). And how to perform a man-overboard maneuver in an emergency is covered in our [MOB guide](/en/blog/man-overboard-maneuver/). Alongside the right signals, solid [first aid on board](/en/blog/first-aid-on-board/) knowledge belongs in every crew's basic toolkit for an emergency.
