...
**Radio tip:** Under normal operation you may only operate a marine radio with the appropriate radio certificate – inland with the [UBI](/en/ubi/), on the coast with the [SRC](/en/src/), and for worldwide voyages with the [LRC](/en/lrc/). Sending a distress call in an acute emergency, however, is permitted to anyone.
...
The acoustic counterparts in normal operation – who gives which sound and when – are summarized in our article on [sound signals for the boating license](/en/blog/sound-signals-sbf-explained/). And how to perform a man-overboard maneuver in an emergency is covered in our [MOB guide](/en/blog/man-overboard-maneuver/). Once help is on the way, caring for the casualty until rescuers arrive is often what matters most – see [First aid on board](/en/blog/first-aid-on-board/) for what to do.
