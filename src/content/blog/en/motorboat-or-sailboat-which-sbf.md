...
The [SBF Inland](/en/sbf-inland/) has two separate scopes: **under engine** and **under sail**. If you only want to run a motorboat, you register for the exam under engine. If you also or exclusively want to sail, you additionally need the sailing scope, and that affects several things:
...
The practical exam under engine focuses on maneuvers that matter for safely handling a motorboat: docking and undocking, turning in a confined space, the man-overboard maneuver, and often an anchoring maneuver too. For a detailed step-by-step guide to the most important mandatory maneuver, see [Man-Overboard Maneuver Under Engine](/en/blog/man-overboard-maneuver/); docking and undocking is covered in [Docking and Undocking – Harbor Maneuvers for Beginners](/en/blog/docking-undocking-harbor-maneuvers/).
...
If you're still unsure which license and scope actually fits what you have in mind, the [boating license finder](/en/tools/which-boating-license/) can help with a few targeted questions. And if you already hold a license and are weighing whether to buy or rent a boat, [Own Boat or Charter Boat After the SBF](/en/blog/own-boat-or-charter-boat-sbf/) is worth a look, though it focuses on cost and responsibility after the exam rather than on choosing a scope.
