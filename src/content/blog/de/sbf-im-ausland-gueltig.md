...
faq:
  - question: "Gilt mein deutscher SBF in Kroatien, den Niederlanden und Italien?"
    answer: "Ja. Alle drei Länder akzeptieren den deutschen ICC (auf der Rückseite des SBF im Scheckkartenformat) für Charterboote. In der Regel brauchst du zusätzlich das SRC-Seefunkzeugnis. Auf niederländischen Binnengewässern ist ohnehin nur bei Booten über 15 m oder mehr als 20 km/h überhaupt eine Fahrerlaubnis nötig – der ICC Inland reicht dafür, die CEVNI-Kenntnisse sind darin bereits enthalten."
  - question: "Was ist der ICC und brauche ich ihn fürs Ausland?"
    answer: "Der ICC (International Certificate of Competence) basiert auf UNECE-Resolution Nr. 40 und steht auf der Rückseite des SBF im Scheckkartenformat. Er wird von den Unterzeichnerstaaten gegenseitig anerkannt und von vielen weiteren Ländern in der Praxis akzeptiert. Alte Papierscheine enthalten keinen ICC und müssen beim DMYV oder DSV umgeschrieben werden."
  ...
  - question: "Gilt in Kroatien auch die 15-PS-Regel wie in Deutschland?"
    answer: "Nein. In Kroatien gibt es keine allgemeine Führerscheinfreiheit für kleine Motorleistungen, die Pflicht beginnt praktisch beim ersten PS. Die einzige Ausnahme betrifft unbemannt vermietete Boote bis 5 m Länge und 5 kW Motorleistung, die Personen ab 18 Jahren in maximal 500 m Ufernähe ohne Führerschein fahren dürfen."
  - question: "Ab wann brauche ich in Italien wirklich einen Bootsführerschein?"
    answer: "Nach Art. 39 des Codice della Nautica da Diporto (D.Lgs. 171/2005) ist die Patente Pflicht, sobald die Motorleistung 30 kW (40,8 PS) übersteigt oder die Fahrt weiter als 6 Seemeilen von der Küste hinausgeht, unabhängig von der Motorleistung. Da Charteryachten fast immer stärker motorisiert sind, brauchst du in der Praxis auf jeder Charterroute den ICC Coastal."
---
...
Wer noch den alten deutschen Sportbootführerschein im Papierformat besitzt, hat **keinen ICC**. Der Umtausch auf das neue Scheckkartenformat ist unkompliziert und wird vom **DMYV (Deutschen Motoryachtverband)** und vom **DSV (Deutschen Segler-Verband)** angeboten. Die Umschreibungsgebühr liegt bei rund 42,66 €, hinzu kommt meist ein Passfoto sowie ein Identitätsnachweis. Die Bearbeitung dauert erfahrungsgemäß einige Wochen, die genauen Anforderungen erfährst du direkt beim jeweiligen Verband.
...
Die kroatische Küstenwache führt auf dem Wasser und in den Häfen regelmäßige Kontrollen durch. Dabei wird neben Führerschein und SRC auch die sogenannte **Vinjeta** geprüft – tatsächlich zwei getrennte Gebühren, die beim Hafenamt zu entrichten sind: eine jährliche **Navigationssicherheitsgebühr** (unabhängig von der Aufenthaltsdauer) sowie für Boote ab 7 m mit Übernachtung an Bord zusätzlich eine **Aufenthaltsgebühr (Kurtaxe)**, die pro Person und Tag berechnet wird (Stand 2026: rund 1,33 € pro Person/Tag, alternativ gestaffelt nach Bootslänge und Aufenthaltsdauer). Kinder bis 12 Jahre und Personen mit einem Behinderungsgrad ab 70 % sind von der Kurtaxe befreit. Charterunternehmen kümmern sich in der Regel um beide Gebühren, aber prüfe ihre Vollständigkeit bei der Bootsübergabe.
...
Anders als in Deutschland gibt es in Kroatien **keine allgemeine 15-PS-Regel**: Sobald ein Boot einen Verbrennungsmotor hat, gilt grundsätzlich Führerscheinpflicht, praktisch ab dem ersten PS. Die einzige nennenswerte Ausnahme betrifft unbemannt vermietete Kleinboote bis 5 m Länge und maximal 5 kW Motorleistung, die eine Person ab 18 Jahren in höchstens 500 m Ufernähe ohne Führerschein steuern darf – etwa ein kleines Tretboot-Alternativ-Motorboot am Strand. Wer die deutsche Führerscheinfreiheit bis 15 PS kennt (siehe unser [Artikel zum Boot fahren ohne Führerschein](/blog/boot-fahren-ohne-fuehrerschein-15-ps/)), sollte sie also nicht automatisch auf Kroatien übertragen. Für eine typische Chartersegel- oder -motorjacht ab ca. 8–10 m kommst du am SBF See + ICC Coastal + SRC ohnehin nicht vorbei. Informiere dich direkt beim Charterunternehmen, falls du einen ungewöhnlichen Bootstyp planst.
...
Das **Wattenmeer (Waddenzee)** ist eines der größten Tide-Flachwassergebiete der Welt und UNESCO-Welterbe. Hier bestimmen Gezeiten und Tidenströme alles. Wer die Tide nicht versteht, sitzt schnell auf einer der zahlreichen Sandbänke fest. Das Wattenmeer setzt grundlegendes Verständnis der Gezeitenrechnung voraus – die [Zwölftelregel](/blog/gezeiten-zwoelftelregel/) erklärt das Grundprinzip anschaulich.
...
In Italien hängt die Führerscheinpflicht von zwei Faktoren ab: der **Motorleistung** und der **Entfernung zur Küste**, in der du fährst.

### Wann brauchst du in Italien wirklich eine Fahrerlaubnis?

Nach **Art. 39 des Codice della Nautica da Diporto** (D.Lgs. 171/2005) ist die Führerscheinpflicht an zwei unabhängige Kriterien geknüpft:

- **Motorleistung über 30 kW (40,8 PS)** oder Hubraum über 750 cm³ (bei Dieselmotoren mehr): Dann ist immer eine Fahrerlaubnis nötig, egal wie nah an der Küste du fährst.
- **Fahrt weiter als 6 Seemeilen von der Küste entfernt:** Dann ist die Fahrerlaubnis Pflicht, unabhängig von der Motorleistung.

Nur wer innerhalb von 6 Seemeilen bleibt **und** ein Boot mit höchstens 30 kW/40,8 PS fährt, kommt in Italien ohne Führerschein aus. Da Charterboote so gut wie immer stärker motorisiert sind, greift für praktisch jede Charterroute – toskanischer Archipel, Sardinien, Sizilien, Amalfiküste – die Führerscheinpflicht, und du brauchst den **ICC Coastal**. Italien hat die UNECE-Resolution Nr. 40 zwar nicht formell unterzeichnet, akzeptiert den ICC aber in der Praxis, insbesondere auf nicht-italienisch geflaggten Charterbooten. Bei Unsicherheit zum konkreten Boot lohnt sich eine kurze Nachfrage beim Charterunternehmen.
...
Die Prüfung ist gut schaffbar und kann oft parallel zur [SBF-See-Prüfung](/sbf-see/) vorbereitet werden. Wenn du ernsthaft im Ausland chartern willst, gehört das SRC auf deine To-do-Liste.
...
Wenn du ohnehin für den [SBF See](/sbf-see/) lernst, ist das SRC der logische nächste Schritt. Beide Prüfungen können oft am gleichen Termin abgelegt werden – frag deine Bootsschule danach.

## Führerschein im Ausland verloren oder beschädigt?

Ein durchnässter oder verlorener Führerschein mitten im Törn ist ärgerlicher Alltag – Spritzwasser, ein liegengelassener Rucksack, ein Diebstahl. Ohne gültiges Original darf der Charter in vielen Ländern nicht fortgesetzt werden, und auch bei Kontrollen drohst du in Schwierigkeiten zu geraten. Am besten fotografierst du Vorder- und Rückseite deines SBF vor der Abreise und hinterlegst die Fotos zusätzlich zu den Originalen digital (z. B. Cloud-Speicher), damit du im Ernstfall zumindest einen Nachweis parat hast. Eine Ersatzausstellung ist im Ausland aber nicht möglich, sie muss über DMYV oder DSV in Deutschland beantragt werden. Wie das genau funktioniert und was ein Ersatzdokument kostet, erklärt unser [Artikel zum Ersatz eines verlorenen oder beschädigten Sportbootführerscheins](/blog/sportbootfuehrerschein-verloren-beschaedigt-ersatz/).
...
Mit dem deutschen SBF See im Scheckkartenformat und dem ICC Coastal auf der Rückseite bist du für die beliebtesten Segelreviere in Europa gut gerüstet. Kroatien und die Niederlande erkennen den ICC formell an, Italien akzeptiert ihn in der Praxis – in allen drei Ländern brauchst du auf Charteryachten in der Regel zusätzlich das SRC. Bereite deine Dokumente rechtzeitig vor, hole aktuelle Infos ein – und genieße dann unbeschwert deinen Törn auf den schönsten Gewässern Europas.
