...
faq:
  - question: "Ist Bootfahren ohne den erforderlichen Sportbootführerschein strafbar?"
    answer: "Wer ein Sportboot führt, obwohl er den dafür erforderlichen Führerschein nicht besitzt, begeht eine Ordnungswidrigkeit. Verstöße gegen die Binnenschifffahrtsstraßen-Ordnung können nach dem Binnenschifffahrtsaufgabengesetz mit einem Bußgeld von bis zu 10.000 Euro geahndet werden."
  - question: "Gilt Unfallflucht auf dem Wasser wie im Straßenverkehr?"
    answer: "Nein. Paragraf 142 StGB, der im Straßenverkehr die Unfallflucht regelt, gilt nach der Rechtsprechung nicht für die Schifffahrt. Stattdessen verpflichten die Schifffahrtsordnungen, etwa Paragraf 1.16 Absatz 3 der Binnenschifffahrtsstraßen-Ordnung, jeden Beteiligten, die Folgen eines Schifffahrtsunfalls festzustellen und seine Identität preiszugeben. Ein Verstoß dagegen ist eine Ordnungswidrigkeit, bei Verletzten kommen zusätzlich Straftatbestände wie unterlassene Hilfeleistung in Betracht."
  - question: "Wer entscheidet über den Entzug des Sportbootführerscheins?"
    answer: "Seit der Zusammenlegung der bis 2017 getrennten See- und Binnen-Verordnungen zur einheitlichen Sportbootführerscheinverordnung (SpFV) entscheidet für beide Geltungsbereiche, Binnen wie See, dieselbe Behörde über die Entziehung: die Generaldirektion Wasserstraßen und Schifffahrt (GDWS), etwa bei wiederholten Verstößen gegen Auflagen."
  - question: "Kann Gewässerverunreinigung durch ein Boot eine Straftat sein?"
    answer: "Ja. Wer unbefugt ein Gewässer verunreinigt, etwa durch das Ablassen von Öl oder Bilgenwasser, macht sich nach Paragraf 324 StGB strafbar. Es drohen Freiheitsstrafe bis zu fünf Jahren oder Geldstrafe, unabhängig von etwaigen zusätzlichen Bußgeldern nach den Schifffahrtsordnungen."
---

Ein Bußgeldbescheid nach einer Bootskontrolle ist ärgerlich, aber verkraftbar. Aus manchen Verstößen auf dem Wasser wird jedoch mehr: der Entzug des [Sportbootführerscheins](/sbf-see/), ein Strafverfahren oder Ärger mit der Bootsversicherung. Wer weiß, welche Fehler besonders teuer werden können und warum, kann sie gezielt vermeiden. Dieser Artikel gibt einen Überblick über die häufigsten Verstöße, ihre rechtliche Einordnung und die tatsächlichen Konsequenzen, ganz ohne Panikmache, aber mit den nötigen Fakten.
...
- **Versicherungsschutz:** Viele Bootsversicherungen kürzen oder verweigern die Leistung bei grob fahrlässigem oder vorsätzlichem Fehlverhalten, etwa Fahren ohne gültigen Führerschein oder unter Alkoholeinfluss. Was eine sinnvolle Bootsversicherung abdecken sollte, erklärt unser Artikel zur [Bootsversicherung für Sportboote](/blog/bootsversicherung-sportboote-sinnvoll/).
...
Im theoretischen Teil des SBF Binnen und des SBF See werden rechtliche Grundpflichten des Schiffsführers regelmäßig abgefragt, etwa zu Vorfahrtsregeln, Ausrüstungspflichten und dem Verhalten nach einem Unfall. Der [ELWIS-Fragenkatalog](/sbf-see-pruefungsfragen/) prüft dabei weniger konkrete Bußgeldsummen als vielmehr das Verständnis dafür, welche Pflichten überhaupt bestehen und warum. Mit der **Boatpass-App** kannst du genau diese Fragen im Prüfungsmodus üben und bekommst direkt Rückmeldung, wo noch Lücken bestehen, bevor es in der echten [SBF-Prüfung](/sbf-pruefung-ablauf/) darauf ankommt.
